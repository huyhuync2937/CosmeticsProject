<%-- 
    ...
    Created on : Mar 1, 2022, 1:58:59 PM
    Author     : DELL
--%>
        ...
        <jsp:include page="Header.jsp"></jsp:include>
            ...
            <div class="container-fluid py-5">
                        ...
                        <div id="product-carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner border">
                                <!--                                <div class="carousel-item active">
                                                                     <img class="w-100 h-100" src="img/3ce-logo.jpg" alt="Image"> 
                                                                </div>-->
                                <div class="carousel-item active">
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <form action="AddProductToCart" method="post" class="d-flex align-items-center mb-4 pt-2">
...
<!--                                <div class="input-group-btn">
                            ...
                            <input name="AddCartProductID" value="${DetailProduct.productID}" hidden="">
