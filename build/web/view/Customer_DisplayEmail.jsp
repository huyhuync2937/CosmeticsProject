<%-- 
    Document   : Customer_DisplayEmail
    Created on : Mar 17, 2022, 5:29:22 PM
    Author     : DELL
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="input-group form-group  mx-auto">
                                    ...
                                    <input name="email" class="form-control" type="text" placeholder="example@email.com" value="${account.email}">
                            </div>
                        </div>
