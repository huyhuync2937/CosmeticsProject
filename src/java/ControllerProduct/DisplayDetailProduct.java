 ...
 * @author DELL
 */
@WebServlet(name = "DisplayDetailProduct", urlPatterns = {"/DisplayDetailProduct"})

public class DisplayDetailProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String productIDDetail = request.getParameter("Detail");
        int id = Integer.parseInt(productIDDetail);
